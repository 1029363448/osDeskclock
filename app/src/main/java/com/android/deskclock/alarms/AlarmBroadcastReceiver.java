...
//            Intent.ACTION_SETTINGS_PACKAGE_DATA_CLEARED;
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (ACTION_ENCRPTION_TYPE_CHANGED.equals(intent.getAction())) {//DC-163
            if (PowerOffAlarmPlatformMTK.CRYPT_TYPE_DEFAULT == PowerOffAlarmPlatformMTK.getPasswordType()/*StorageManager.CRYPT_TYPE_DEFAULT == PowerOffAlarm.getPasswordType()*/) {
