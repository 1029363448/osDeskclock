...
import com.ape.deskclock.sdk.encapsulation.DeskClockSdkEncapsulation;
...
public class DeskClockApplication extends Application {
    ...
    private static SharedPreferences getDefaultSharedPreferences(Context context) {
        ...
        if (Utils.isNOrLater()) {
            ...
            /// M: [ALPS03432698] [FBE] Delay migration of db till user unlocks the phone @{//DC-163
            if(WrapperManager.isMtkPlatform()) {
                if (/*UserManager.get(context).isUserUnlocked()*/DeskClockSdkEncapsulation.get(context).isUserUnlocked()) {
